...
export const projects: ProjectsProps[] = [
  ...
  },
  {
    ...
    description:
      "Search, filter and show characters. Save favorite card in a database.",
    tecnologies: "CSS Modules, React, Redux, Express, PostgreSQL.",
  ...
  },
  {
    ...
    tecnologies:
      "TypeScript, React, NextJS, TailwindCSS, Prisma, MongoDB, Pusher.",
